  ...
  return (
    <main className='flex flex-col w-full h-full'>
      ...
      <div className="hero flex items-center justify-center flex-col text-center gap-12 mt-40 mb-40">
        <div className="heading  w-2/3"><p className='text-7xl font-bold'>The Ultimate <span className='bg-gradient-to-r from-blue-600 via-purple-500 to-indigo-400 bg-clip-text text-transparent'>Note-Taking</span> Experience</p></div>
        <div className="subheading "><p className='text-xl text-gray-600'>Simplify your workflow with NoteScape&apos;s all-in-one note-taking solution.</p></div>
      ...
      <div className="features flex flex-col items-center text-center gap-12 p-8">
        <div className="feature-description text-xl text-gray-600">NoteScape offers a wide range of features to enhance your note-taking experience.</div>
          ...
          <div className="feature-list grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl">
            ...
            <div className="feature-item p-4 border-2 border-gray-200 rounded-lg shadow-lg h-40 lg:col-start-2">
              <div className="feature-title text-2xl font-bold">Novel.sh Editor 📝</div>
              <div className="feature-text text-lg text-gray-600">Experience seamless writing with Novel.sh, a editor with tons of features!</div>
            </div>
            
          </div>
          <div className=""><p>see more <span className='underline font-semibold text-violet-400 hover:text-purple-400 transition'><Link href={"/Features"}>Features</Link></span></p></div>
      </div>
      <Footer />
    </main>
  )
